...
public class Productpage { 
	...
	{
		List<WebElement>pl=driver.findElements(By.xpath("//div[@class='inventory_item']"));
	...
	public List<Double> productPriceList() {
		List<WebElement>p=wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[@class='inventory_item']")));
		List<Double>prices=new ArrayList<>();
		for(WebElement product:p) {
			WebElement prodPrice=product.findElement(By.xpath(".//div[@class='inventory_item_price']"));
			prodPrice=wait.until(ExpectedConditions.visibilityOf(prodPrice));
			String priceText=prodPrice.getText().replace("$","").trim();
	...
	public void addToCart() {
		List<WebElement>add=wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[@class='inventory_item']")));
		for(WebElement addto:add) 
		{
			WebElement addtocart = addto.findElement(By.xpath(".//button[text()='ADD TO CART']"));
	...
	public void Allitems() {
		...
		WebElement allitems=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@id='inventory_sidebar_link']")));
		allitems.click();
	}
	...
	public void Logout() {
		...
		WebElement logout=wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@id='logout_sidebar_link']")));
		logout.click();
	}
	...
	public void removebuttonproductpage() {
		List<WebElement>e=wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//div[@class='inventory_item']")));
		for(WebElement el:e) {
			WebElement remove = el.findElement(By.xpath(".//button[text()='REMOVE']"));
			remove=wait.until(ExpectedConditions.elementToBeClickable(remove));
			remove.click();	
		}
	}
	...
	public boolean checkbutton() {
		...
		for(WebElement addto:add) {
			...
			WebElement addtocart = addto.findElement(By.xpath(".//button[@class='btn_primary btn_inventory']"));
			addtocart=wait.until(ExpectedConditions.visibilityOf(addtocart));
			//inspect cart button
